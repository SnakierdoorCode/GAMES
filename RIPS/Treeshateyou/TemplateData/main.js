...
const rootBuildPath = "/TemplateData/Build/";

Promise.all([
    mergeFiles(getParts(rootBuildPath + "TreesHateYou_Web.data.br", 1, 5)),
    mergeFiles(getParts(rootBuildPath + "TreesHateYou_Web.wasm.br", 1, 4))
