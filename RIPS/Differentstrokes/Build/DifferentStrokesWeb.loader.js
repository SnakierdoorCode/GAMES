function createUnityInstance(t, n, l) {
    ...
    var f, h, m, p, g, w, v, y, k, _ = {
        ...
        ConnectToProfiler: function() {
            if (b.ConnectToProfiler)
                return b.ConnectToProfiler.apply(b, arguments);
            b.print("Failed to execute ConnectToProfiler: Player not loaded yet.")
        },
        StopProfiling: function() {
            if (b.StopProfiling)
                return b.StopProfiling.apply(b, arguments);
            b.print("Failed to execute StopProfiling: Player not loaded yet.")
        },
        IsConnectedToProfiler: function() {
            if (b.IsConnectedToProfiler)
                return b.IsConnectedToProfiler.apply(b, arguments);
            b.print("Failed to execute IsConnectedToProfiler: Player not loaded yet.")
        },
        Quit: function() {
        ...
        GetMetricsInfo: function() {
            ...
            return {
                ...
                codeDownloadTime: b.HEAPU32[c >> 2],
    ...
    function P(e) {
        return P.link = P.link || document.createElement("a"),
        P.link.href = e,
        P.link.href
    }
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (f < d)
                        return c.slice(0, f);
                    for (var t = new Uint8Array(f), n = (t.set(c, 0),
                    h), r = 0; r < u.length; ++r)
                        t.set(u[r], n),
                        n += u[r].length;
                    return t
                }
                return f + e.value.length <= c.length ? (c.set(e.value, f),
    ...
    ,
    C.UnityCacheDatabase = f,
    C.RequestMetaDataStore = h,
    ...
    function(o, a) {
        var e, t, i = v.getInstance(), s = P("string" == typeof o ? o : o.url), l = {
            enabled: (e = s,
        ...
        function d(n, r) {
            return fetch(n, r).then(function(e) {
                ...
                i.updateRequestMetaData(l.metaData).then(function() {
                    E("'" + l.metaData.url + "' successfully revalidated and served from the browser cache")
                }).catch(function(e) {
                    E("'" + l.metaData.url + "' successfully revalidated but not stored in the browser cache due to the error: " + e)
                }),
        ...
        l.enabled ? i.loadRequest(s).then(function(e) {
            ...
            i.updateRequestMetaData(r).then(function() {
                E("'" + l.metaData.url + "' served from the browser cache without revalidation")
            }),
            ...
            d(o, a)) : fetch(s, {
                ...
                k(l.response, a.onProgress, a.enableStreamingDownload)) : d(o, a)
            }))) : d(o, a)
        }).catch(function(e) {
            return E("Failed to load '" + l.metaData.url + "' from browser cache due to the error: " + e),
            y(o, a)
        }) : y(o, a)
    }
    );
                ...
                var t, n = {
                    "inflate.js": function(e, t, n) {
                        ...
                        i.prototype.push = function(e, t) {
                            var n, r, o, a, i, s = this.strm, l = this.options.chunkSize, d = this.options.dictionary, c = !1;
                            if (this.ended)
                                return !1;
                            ...
                            do {
                                ...
                                s.next_out = 0,
                                s.avail_out = l),
                                (n = u.inflate(s, m.Z_NO_FLUSH)) === m.Z_NEED_DICT && d && (i = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === b.call(d) ? new Uint8Array(d) : d,
                                n = u.inflateSetDictionary(this.strm, i)),
                                n === m.Z_BUF_ERROR && !0 === c && (n = m.Z_OK,
                                c = !1),
                    ...
                    "zlib/inflate.js": function(e, t, n) {
                        ...
                        n.inflate = function(e, t) {
                            var n, r, o, a, i, s, l, d, c, u, f, h, m, b, p, g, w, v, y, k, _, S, x, C, E = 0, P = new D.Buf8(4), U = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 6:
                                    ...
                                    512 & n.flags && (n.check = B(n.check, r, h, a)),
                                    s -= h,
                                    a += h,
                                    n.length -= h),
                                    n.length))
                                ...
                                case 7:
                                    if (2048 & n.flags) {
                                        ...
                                        _ && h < s; )
                                            ;
                                        if (512 & n.flags && (n.check = B(n.check, r, h, a)),
                                        s -= h,
                                        a += h,
                                        _)
                                            break e
                                ...
                                case 13:
                                    if (n.last)
                                        ...
                                        case 0:
                                            ...
                                            break;
                                        case 1:
                                            var A, A = T = void 0, T = n;
                                            if (W) {
                                                for (N = new D.Buf32(512),
                                                H = new D.Buf32(32),
                                                A = 0; A < 144; )
                                                    T.lens[A++] = 8;
                                                for (; A < 256; )
                                                ...
                                                for (; A < 288; )
                                                    T.lens[A++] = 8;
                                                for (z(1, T.lens, 0, 288, N, 0, T.work, {
                                                    bits: 9
                                                }),
                                                A = 0; A < 32; )
                                                    T.lens[A++] = 5;
                                                z(2, T.lens, 0, 32, H, 0, T.work, {
                                                    bits: 5
                                                }),
                                                W = !1
                                            }
                                ...
                                case 18:
                                    ...
                                    S = z(0, n.lens, 0, 19, n.lencode, 0, n.work, x),
                                    n.lenbits = x.bits,
                                    S) {
                                ...
                                case 19:
                                    for (; n.have < n.nlen + n.ndist; ) {
                                        for (; g = (E = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !((p = E >>> 24) <= c); ) {
                                            if (0 === s)
                                                break e;
                                    ...
                                    S = z(1, n.lens, 0, n.nlen, n.lencode, 0, n.work, x),
                                    n.lenbits = x.bits,
                                    S) {
                                    ...
                                    S = z(2, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, x),
                                    n.distbits = x.bits,
                                    S) {
                                ...
                                case 21:
                                    ...
                                    for (n.back = 0; g = (E = n.lencode[d & (1 << n.lenbits) - 1]) >>> 16 & 255,
                                    w = 65535 & E,
                                    !((p = E >>> 24) <= c); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (g && 0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (E = n.lencode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !(v + (p = E >>> 24) <= c); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    n.mode = 23;
                                case 23:
                                    for (; g = (E = n.distcode[d & (1 << n.distbits) - 1]) >>> 16 & 255,
                                    w = 65535 & E,
                                    !((p = E >>> 24) <= c); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & g)) {
                                        for (v = p,
                                        y = g,
                                        k = w; g = (E = n.distcode[k + ((d & (1 << v + y) - 1) >> v)]) >>> 16 & 255,
                                        w = 65535 & E,
                                        !(v + (p = E >>> 24) <= c); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 27:
                                    if (n.wrap) {
                                        ...
                                        e.total_out += f,
                                        n.total += f,
                                        f && (e.adler = n.check = (n.flags ? B : I)(n.check, o, f, i - f)),
                                        f = l,
                                        (n.flags ? d : M(d)) !== n.check) {
                            ...
                            e.total_out += f,
                            n.total += f,
                            n.wrap && f && (e.adler = n.check = (n.flags ? B : I)(n.check, o, f, e.next_out - f)),
                        ...
                        n.inflateSetDictionary = function(e, t) {
                            var n, r = t.length;
                            return !e || !e.state || 0 !== (n = e.state).wrap && 11 !== n.mode ? O : 11 === n.mode && I(1, t, r, 0) !== n.check ? -3 : Z(e, t, r, r) ? (n.mode = 31,
                            -4) : (n.havedict = 1,
                            L)
                        }
                        ,
                    ...
                    "zlib/inffast.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t) {
                            var n, r, o, a, i, s, l = e.state, d = e.next_in, c = e.input, u = d + (e.avail_in - 5), f = e.next_out, h = e.output, m = f - (t - e.avail_out), b = f + (e.avail_out - 257), p = l.dmax, g = l.wsize, w = l.whave, v = l.wnext, y = l.window, k = l.hold, _ = l.bits, S = l.lencode, x = l.distcode, C = (1 << l.lenbits) - 1, E = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (k += c[d++] << _,
                                _ += 8,
                                k += c[d++] << _,
                    ...
                    "zlib/inftrees.js": function(e, t, n) {
                        ...
                        t.exports = function(e, t, n, r, o, a, i, s) {
                            for (var l, d, c, u, f, h, m, b, p, g = s.bits, w = 0, v = 0, y = 0, k = 0, _ = 0, S = 0, x = 0, C = 0, E = 0, P = 0, U = null, A = 0, T = new R.Buf16(16), D = new R.Buf16(16), I = null, B = 0, w = 0; w <= 15; w++)
                                T[w] = 0;
                            for (v = 0; v < r; v++)
                                T[t[n + v]]++;
                            for (_ = g,
                            ...
                            0 === k)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (m = w - x),
                                    y = d = 1 << S; o[f + (P >> x) + (d -= l)] = m << 24 | b << 16 | p | 0,
                                    0 !== d; )
                                        ;
                                    for (l = 1 << w - 1; P & l; )
                                        l >>= 1;
                                    ...
                                    if (_ < w && (P & u) !== c) {
                                        for (f += y,
                                        C = 1 << (S = w - (x = 0 === x ? _ : x)); S + x < k && !((C -= T[S + x]) <= 0); )
                                            S++,
                                            C <<= 1;
                                        if (E += 1 << S,
                                        1 === e && 852 < E || 2 === e && 592 < E)
                                            return 1;
                                        o[c = P & u] = _ << 24 | S << 16 | f - a | 0
                                    }
                                }
                                0 !== P && (o[f + P] = w - x << 24 | 64 << 16 | 0),
                                s.bits = _
                            }
                            return 0
                        }
    ...
    function T() {
        var t = performance.now()
          , m = (Promise.all([A("frameworkUrl").then(function(e) {
        ...
        b.preRun.push(function() {
            ...
            e.then(function(t) {
                ...
                for (n + s > t.length && o("Invalid binary data file header! (pos=" + n + ", headerSize=" + s + ", file length=" + t.length + ")"); n < s; ) {
                    var l = r()
                      , d = r()
                      , c = (l + d > t.length && o("Invalid binary data file size! (offset=" + l + ", size=" + d + ", file length=" + t.length + ")"),
                    r())
                      , u = (n + c > t.length && o("Invalid binary data file path name! (pos=" + n + ", length=" + c + ", file length=" + t.length + ")"),
                    e.decode(t.subarray(n, n + c)));
                    n += c;
    ...
    return new Promise(function(e, t) {
        ...
        t(n)) : b.SystemInfo.hasWasm ? b.SystemInfo.hasWasm2023 ? (b.startupErrorHandler = t,
        l(0),
