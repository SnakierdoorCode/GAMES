...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            // Define parts inside the scope to prevent duplicate declaration errors
            var partsToLoad = [
                'Build/67d21dd6ddd827425bdc245f02f12be6.data.unityweb.part1',
                'Build/67d21dd6ddd827425bdc245f02f12be6.data.unityweb.part2'
            ]

            var loadDataPromise = typeof window.loadCombinedDataUrl === 'function'
                ? window.loadCombinedDataUrl(partsToLoad)
                    ...
                    .then(combinedDataUrl => {
                        return createUnityInstance(
                            CANVAS,
                            {
                                ...
                                frameworkUrl: 'Build/90b94b3c2cea1b5d647fd86e784e4681.framework.js.unityweb',
                                codeUrl: 'Build/b098b1d93c47d262a7dc6492f585171b.wasm.unityweb',
